...
$product_type_to_display = 'activewear'; // Set the product type you want to display
...
<section id="page-header" class="active-header">
  <h1>#NoPainNoGain</h1>
  <h3>Train With Our Activewear Products</h3>
</section>
