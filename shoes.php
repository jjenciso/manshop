...
$product_type_to_display = 'shoes'; // Set the product type you want to display
...
<section id="page-header" class="shoes-header">
  <h1>#freshKicks</h1>
  <h3>Complete your swag with our fresh kicks</h3>
</section>
