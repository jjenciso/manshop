...
$product_type_to_display = 'jeans'; // Set the product type you want to display
...
<section id="page-header" class="bottoms-header">
  <h1>#shortsToJeans</h1>
  <h3>From Shorts to Jeans We got you Covered</h3>
</section>
